...
@section('index.con')
    @include('layouts.nav')
        <h1 style="margin-top: 5%;text-align: center;">新增樂譜</h1>
<br>
        <div class="content">
            <form action="{{route('sheet.store')}}" method="POST" role="form" onsubmit="success()">
                ...
                <div class="form-group">
                    ...
                    <input name="year" class="form-control-itemname" type='year' placeholder="請填寫樂譜發行年份" id="remark">
                </div>
                <div class="form-group">
                    <label for="price" class="inline">購譜價格：</label>
                    <input name="price" class="form-control-itemname" placeholder="請填寫樂譜購入價格" id="remark">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input name="remark" class="form-control-itemname" placeholder="如果有其他備註或重奏聲部類別請在此處填寫"id="remark">
                </div>
                <div class="form-group">
