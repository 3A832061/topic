    ...
    <main class="flex-shrink-0">
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <form action="{{route('active.store')}}" method="POST" role="form" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="url" name="url" class="form-control" rows="2" placeholder="請輸入連結網址"></textarea>
